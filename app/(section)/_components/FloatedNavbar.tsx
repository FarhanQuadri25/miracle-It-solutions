...
const Tab = ({ children, href, setPosition }: TabProps) => {
  ...
  return (
    <li
      ...
      className="relative z-10 block cursor-pointer px-3 py-1.5 text-lg font-inter uppercase text-white mix-blend-difference md:px-5 md:py-3 md:text-base"
    >
...
const Cursor = ({ position }: CursorProps) => {
  return (
    <motion.li
      ...
      className="absolute z-0 h-10 rounded-full bg-[#171717] md:h-12"
    />
  );
};
